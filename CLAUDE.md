...
**A judgement call about whether a tree is good enough NEVER blocks publication.** Not size, not age, not fame, not how many sources agree, not whether it is the best tree in its park, and not its position in a queue: "the city already has ten" and "this was ninth in line" are not reasons, they are the count doctrine misread (see "The count follows the trees" above). Every one of those is correctable after the fact by an edit or a reader, and being wrong about them costs nothing. Publish, flag what is thin, move on.
