...
4. **New coverage: the Japan wave, then the recorded wave order.** Reopened by Hidde 2026-07-30 ("die hele kwaliteitsstop kan eraf, we gaan voor kwantiteit"); the depth exit test is retired, its history in DECISIONS.md.
   ...
   - **TOP OF THE QUEUE, ruled by Hidde 2026-08-09: build Porto and Lisbon to an optimum level, ahead of everything below.** Not because they are the biggest tourist cities, but because they are the only two places on this site where the search evidence is already positive. Over the 28 days to 2026-08-09 the whole site took 78 clicks on 3,680 impressions, and Lisbon (8 clicks on 150 impressions) plus Porto (4 on 29) produced 15 percent of every click from 2 of 95 cities. Porto is in no phase of the rollout and outperforms cities that are. Rome, our deepest page at 24 trees, took 61 impressions and zero clicks in the same window. Read that honestly: depth does not produce clicks, POSITION does, and in Portugal we rank because the competition is thin. So the cheapest real traffic on this site is more pages in the country where we already win, and "optimum level" means the full depth bar (several complete walks, photos on most of them, honest pins, season data where it is real) rather than a tree count. Porto has 17 trees against 26 registered in its main cluster and two further clusters of 6 and 5; Lisbon has 21 against three clusters holding 29, 17 and 10. Both are supply-rich, so this is selection work rather than research. The caveat, stated because the numbers are small: Porto's evidence is 29 impressions, and its 14 percent click rate is remarkable but thin. Lisbon carries the harder proof.

   - **Current focus, ruled by Hidde 2026-08-06 (evening, superseding the same morning's Rome/Lisbon/Porto ruling): the tourist-city rollout, London first.** His strategy, his words: "een paar hele grote steden een hele goede ervaring geven". Phase 1 is ten cities that combine maximum tourism, English-language search and tree stories: **London, Paris, New York, Rome, Amsterdam, Chicago, Washington DC, Boston, Barcelona, Berlin.** The UK is the first country to dominate, Europe the first continent. Lisbon and Rome he counts as the only current pages at decent scale; everything else in phase 1 is thin or absent. **Small-city work stops: no more Padua-or-Genoa-class cities** ("no longer waste time on padova of genoa"). Existing small pages stay live and get nothing new; reader submissions still outrank everything. (A session briefly reopened this on 2026-08-08 by misreading an instruction; Hidde corrected it within the hour and the stop stands. DECISIONS.md has the record.)
