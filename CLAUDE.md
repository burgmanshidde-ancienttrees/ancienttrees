...
- **Search the city's parks first (Hidde, 2026-08-02, from having walked Lisbon): "in lissabon staan ze bijna altijd daar".** Before the generic "[city] oldest trees" sweep, list the city's historic parks, botanical gardens, palace grounds and cemeteries by name, then search each one. That is where old trees survived, because someone protected the ground around them; a park name plus a species name finds trees that no "remarkable trees" listicle mentions. Lisbon's Jardim da Estrela is the worked example: famous for its giant ficus and its jacarandas, and missed entirely by the city-level sweep.
- **Then search the city's sacred ground (Hidde, 2026-08-02).** Churchyards, cathedral closes, monasteries, convent gardens, temple and shrine precincts, mosque courtyards and old cemeteries. Same mechanism as the parks and stronger: the ground was never redeveloped, someone tended it for centuries, and in many places the tree predates the building beside it. Measured across our own data the day the rule was written, 146 of 546 published trees (26 percent) already stand on sacred ground across 60 of 78 cities, without anyone having searched for it deliberately; Kyoto, Seville, Tokyo, Edinburgh, Granada, Venice and York lead. Search it by name per site, the way the parks are searched, and the local words too (kerk, klooster, iglesia, ermita, chiesa, igreja, Kirche, jinja, taisha, -ji).
