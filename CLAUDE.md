...
**The course after the fortnight, ruled by Hidde 2026-08-12; the planned 2026-08-14 review is cancelled ("zet die geplande evaluatie uit je hoofd en bestand, we kunnen gewoon door, ik heb genoeg bevestiging om door te gaan").** The steady fortnight's fifty-fifty split (half quality backfill, half new coverage) ends with it. The course he confirmed, in his words "eens met register hoek en alleen verdieping wanneer de moeite": supply comes register-first and from the READY leads pile (`python3 scripts/leads.py`; write passes are the only assembly-line stage measured under the 15k target, ~12k per tree against ~46k for web-research verify), and depth work (photos, pins, best_time) is dispatched only on pages where Search Console shows impressions. Depth on a page without demand is the measured waste of the 2026-08-05 to 08-10 week (Baarn 556k tokens for zero, pin passes on Washington and Edinburgh 275k for zero upgrades). There is no new review date; evidence and Hidde move the course, not the calendar. The never-cuttable list, the hard rules and the research bar are untouched, as always.
