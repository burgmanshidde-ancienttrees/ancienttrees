...
6. **New cities are frozen at the current 33.** Phase 1 of GO_TO_MARKET.md opened on 2026-07-26: Google is indexing and impressions double daily, so the scarce thing is no longer supply, it is making the pages people land on deliver the promise. A visitor who lands on a city with vague pins and no photos does not come back, and that is the person who would one day pay. Hidde can reopen coverage by marking this rung; a run may not.
