...
His words, looking at their Plus page: "ik vind persoonlijk AllTrails heel vergelijkbaar en dit is precies waar we heen moeten bouwen." What that makes canonical: web-first with the SEO layer as front door, the app as the deeper product, every tree and story free forever-of-the-moment, and the paid tier selling convenience around the walk (their offline maps / route conditions / wrong-turn alerts / Garmin export map onto our offline city packs / season alerts / on-walk guidance / GPX). Their price is theirs; ours stays undecided (hard rule 2, and the interim paywall line in CLAUDE.md stays open). The IA benchmark synthesis of 2026-07-28 uses AllTrails as the backbone and the other eight products as seasoning. Sharpened the same day when the first benchmark results landed and Hidde ruled "niet te moeilijk doen, onze hele strategie gooien op het nabouwen van deze strategieen": **copy the form, keep the soul.** Structure, funnel, nav, paywall placement and URL grammar get copied shamelessly from the proven players (principle 7 at strategy level); the differentiation lives in what fills the form: ten curated trees instead of everything, verified stories, honest pins, the season, years as the currency. An AllTrails clone with trees loses to AllTrails; Ancient Trees poured into AllTrails' form beats both. Sealed by Hidde after reading the full nine-product synthesis and PRODUCT_IA.md ("oke allemaal eens... dit is een hele duidelijke product richting"): **ziel = bomen; product-vorm = AllTrails nabouwen; wandelroutes als extra, niet als basis.** That sentence is the product direction.
