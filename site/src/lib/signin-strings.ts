...
export const SIGNIN: Record<Lang, SignInStrings> = {
  en: {
    ...
    subExpired: "A sign-in link works once and only for a short while. You can ask for a new one below.",
  ...
  es: {
    ...
    subExpired: "Un enlace de acceso funciona una vez y solo durante un rato. Puedes pedir uno nuevo aquí abajo.",
  ...
  it: {
    ...
    subExpired: "Un link di accesso funziona una volta e solo per poco tempo. Puoi chiederne uno nuovo qui sotto.",
  ...
  nl: {
    ...
    subExpired: "Een inloglink werkt één keer en maar kort. Je kunt hieronder een nieuwe aanvragen.",
  ...
  de: {
    ...
    subExpired: "Ein Anmeldelink funktioniert einmal und nur kurze Zeit. Unten kannst du einen neuen anfordern.",
  ...
  pt: {
    ...
    subExpired: "Um link de acesso funciona uma vez e só durante pouco tempo. Podes pedir um novo aqui em baixo.",
  ...
  fr: {
    ...
    subExpired: "Un lien de connexion ne fonctionne qu'une fois et pendant peu de temps. Vous pouvez en demander un nouveau ci-dessous.",
  ...
  ja: {
    ...
    subExpired: "サインインリンクは短い時間に1回だけ使えます。下から新しいリンクをリクエストできます。",
